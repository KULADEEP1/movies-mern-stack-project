...
const HeroSlide = ({ mediaType, mediaCategory }) => {
    ...
    useEffect(() => {
        ...
        getGenres()
    }, [mediaCategory, mediaType, dispatch])
    return (
        <Box sx={{
            position: "relative",
                ...
                {movies.map((movie, index) => (
                    <SwiperSlide key={index}>
                        <Box sx={{
                            ...
                            backgroundImage: `url(${tmdbConfigs.backdropPath(movie.backdrop_path || movie.poster)})`
                        }} />
                        <Box sx={{
                            width: "100%",
                            height: "100%",
                        ...
                        <Box sx={{
                            ...
                            top: 0,
                            left: 0,
                            paddingX: { sm: "10px", md: "5rem", lg: "2rem" }
                        }} >
                            <Box sx={{
                                height: "100%",
                                display: "flex",
                                ...
                                <Stack spacing={4} direction="column" >
                                    ...
                                    <Typography
                                        variant="h4"
                                        fontSize={{ sx: "2rem", md: "2rem", lg: "4rem" }}
                                        fontWeight="700"
                                        sx={{
                                    ...
                                    {/* overview */}
                                    <Typography variant="body1" color="white" sx={{ ...uiConfigs.style.typoLines(3, "left") }} >
                                        {movie.overview}
                                    </Typography>
                                    {/* overview */}
